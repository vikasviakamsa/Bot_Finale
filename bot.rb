...
HINTS = UI::QuickReplies.build(["Create a board", "QUESTIONNAIRE"],["Search New", "CAROUSEL"],
                               ["Where am I?", "LOCATION"])
...
questionnaire_replies = UI::QuickReplies.build(%w[New CREATE_BOARD],
                                               %w[Existing STOP_CREATE_BOARD])
...
Bot.on :message do |message|
  ...
  Rubotnik::MessageDispatch.new(message).route do
    ...
    bind 'create', to: :create_board, start_thread: {
